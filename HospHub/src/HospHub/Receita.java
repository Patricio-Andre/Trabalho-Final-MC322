...
public class Receita {
    ...
    public void defineNumeroArquivo() {
        ...
        for (int i = 0; i < numeroArquivo; i++) {
            ...
            String caminhoArquivo = diretorioPrincipal + File.separator + "Receita_" + paciente.getCPF() + "_"
                    + numeroArquivo + ".txt";
    ...
    public void salvarArquivo() {
        ...
        try {
            ...
            writer.write(
                    "Assinatura do profissional de saúde responsável: _________________________________________________________");
            writer.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
