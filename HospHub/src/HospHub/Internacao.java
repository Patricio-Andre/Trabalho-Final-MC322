...
public class Internacao {
    ...
    public Internacao(Paciente paciente, Enfermeire enfermeire, Medique medique, double custo, LocalDateTime entrada,
            LocalDateTime saida, Hospital hospital) {
        try {
    ...
    public String toString() {
        return "A internacao do paciente " + paciente + " que se iniciou" + entrada + " de id " + id + " e acabara em "
                + saida; // nao botei o medico ou enfermeiro pq ia ficar medico chamando paciente 2 vezes
    }
}
