     ...
     //   JLabel label9 = new JLabel("Gravidade:");
      ...
      //  layout.putConstraint(SpringLayout.EAST, textField5, 0, SpringLayout.EAST, textField);
       ...
       // JLabel label11_ = new JLabel("ID do convenio:");
        ...
        //layout2.putConstraint(SpringLayout.NORTH, textField6_, -2, SpringLayout.NORTH, label5_);
       // layout2.putConstraint(SpringLayout.EAST, textField6_, 0, SpringLayout.EAST, textField_);
